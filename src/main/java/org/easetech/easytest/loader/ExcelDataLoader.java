...
public class ExcelDataLoader implements Loader {
    ...
    private Map<String, List<Map<String, Object>>> loadFromSpreadsheet(final InputStream excelFile) throws IOException {
        ...
        return finalData;// clearNullData(finalData);
    }
    
    private static Map<String, List<Map<String, Object>>> clearNullData(Map<String, List<Map<String, Object>>> data) {
    	Collection<List<Map<String, Object>>> data2 = data.values();
    ...
    private LinkedHashMap<String, Object> initializeRowData(Row row , XSSFWorkbook workbook , LinkedHashMap<String, Object> actualData){      
    ...
    private Boolean isKeyRow(Row row , XSSFWorkbook workbook){
